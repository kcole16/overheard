...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'hype_topic', 'title', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Topic.title'
        db.alter_column(u'hype_topic', 'title', self.gf('django.db.models.fields.CharField')(max_length=140))
